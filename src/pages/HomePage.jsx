        ...
        <ContentBlock>
          <div style={{ textAlign: "center" }}>
            ...
            <h3 style={{ marginTop: "0", fontWeight: "normal" }}>
              Entre com as expressões algébricas para T<sub>1</sub> e T
              <sub>2</sub>. O sistema irá extrair as matrizes automaticamente.
            </h3>
          </div>

          <EntradaTransformacaoLinear
            n={1}
            x={T1At0}
            y={T1At1}
            z={T1At2}
